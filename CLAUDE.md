...
- `/harga_set`: `send_harga_set_summary` (🟦 TikTok Shop per-variant `Rp{listing} (Rp{unit}/pcs)` + skipped note; 🟧 Shopee base price + Harga Grosir tiers + skipped-pack note; `_(tidak ada)_` for an absent platform).
